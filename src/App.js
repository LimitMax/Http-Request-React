  ...
  render() {
    return (
      <div className="container ">
        <h1>Latihan HTTP Request DevSchool</h1>
        <div className="row bg-info">
                ...
                <div className="col-md-6" key={index}>
                  <div className="card" style={{ margin: 10 }}>
                    <div className="card-body">
                      <h5 className="card-title">No: {member.id}</h5>
                      <h5 className="card-title">{member.first_name}</h5>
                      <h5 className="card-title">{member.last_name}</h5>
                      <button className="btn btn-success m-1" onClick={() => this.editButtonHandler(member)}>
                        Edit
                      </button>
                      <button className="btn btn-danger m-1" onClick={() => this.deleteButtonHandler(member.id)}>
                        Delete
                      </button>
                    </div>
                  </div>
          ...
          <div className="col-md-6" style={{ border: "2px solid green" }}>
            ...
            <form onSubmit={this.onSubmitHandler}>
              ...
              <button type="submit" className="btn btn-primary m-1" disabled={this.state.buttonDisabled}>
                Simpan
              </button>
            </form>
          </div>
